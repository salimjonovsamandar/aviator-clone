					...
					<div className="bet-block">
						<div className="bet-spinner">
							<div className={`spinner ${betState || betted ? "disabled" : ""}`}>
								...
								<div className="input">
									{betState || betted ?
										<input type="number" value={isFocus ? Number(myBetAmount) : Number(myBetAmount).toFixed(2)} readOnly ></input>
										:
										<input type="number" value={isFocus ? Number(myBetAmount) : Number(myBetAmount).toFixed(2)}
											onBlur={() => {
												setIsFocus(false)
											}}
											onFocus={() => {
