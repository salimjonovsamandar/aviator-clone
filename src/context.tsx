...
export const setNumberFunc = async (amount: number) => {
  let response = await axios.post(`${config.api}/set-game-number`, {
    amount,
  });
...
export const getNumberFunc = async () => {
  let response = await axios.post(`${config.api}/get-game-number`);
  return response.data;
};
export const updateNumberFunc = async (data) => {
  let response = await axios.post(`${config.api}/update-game-number`, data);
  if (response.data.status) {
    toast.success("Changed the number successfully.");
  }
  return response.data;
};
export const deleteNumberFunc = async (_id) => {
  let response = await axios.post(`${config.api}/delete-game-number`, { _id });
  if (response.data.status) {
    toast.success("Deleted the number successfully.");
  }
  return response.data;
};

export const deleteAllNumbersFunc = async () => {
  let response = await axios.post(`${config.api}/delete-game-numbers`);
  if (response.data.status) {
    toast.success("Deleted the number successfully.");
  }
  return response.data;
...
export const getBotUsersFunc = async () => {
  let response = await axios.post(`${config.api}/get-bot-user`);
  return response.data;
};
export const updateBotUserFunc = async (data) => {
  let response = await axios.post(`${config.api}/update-bot-user`, data);
  if (response.data.status) {
    toast.success("Changed the user successfully.");
  }
  return response.data;
};
export const deleteBotUserFunc = async (_id) => {
  let response = await axios.post(`${config.api}/delete-bot-user`, { _id });
  if (response.data.status) {
...
export const deleteBotUsersFunc = async () => {
  let response = await axios.post(`${config.api}/delete-bot-users`);
  if (response.data.status) {
    toast.success("Deleted the user successfully.");
  }
  return response.data;
